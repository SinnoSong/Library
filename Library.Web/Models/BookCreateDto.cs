...
namespace Library.Web.Models
{
    public class BookCreateDto
    {
        ...
        public BookCreateDto(string title, string? summary, decimal? price, string? isbn, string? image, int pages, string author, string location, bool isLend, Guid categoryId)
        {
            Title = title;
            Summary = summary;
            Price = price;
